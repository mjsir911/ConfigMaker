...
class MyWindow(PySide.QtGui.QMainWindow):
    ...
    class MainWidget(PySide.QtGui.QWidget):
        def __init__(self, parent=None):
            super(MyWindow.MainWidget, self).__init__(parent)
        ...
        class RatingsWidget(Py.QtGui.QWidget):
            def __init__(self, parent=None):
                super(MyWindow.MainWidget.RatingsWidget, self).__init__(parent)
                self.parent = parent
            ...
            class SingularRating(Py.QtGui.QWidget):
                def __init__(self, parent=None):
                    super(MyWindow.MainWidget.RatingsWidget.SingularRating, self).__init__(parent)
                ...
                class OptionalOptions(Py.QtGui.QWidget):
                    def __init__(self, playout, parent=None):
                        super(MyWindow.MainWidget.RatingsWidget.SingularRating.OptionalOptions, self).__init__(parent)
                        self.responses = []
                    ...
                    class Responses(Py.QtGui.QWidget):
                        def __init__(self, num, parent=None):
                            super(MyWindow.MainWidget.RatingsWidget.SingularRating.OptionalOptions.Responses, self).__init__(parent)
                            self.layout = Py.QtGui.QVBoxLayout()
                    ...
                    def show(self):
                        super(MyWindow.MainWidget.RatingsWidget.SingularRating.OptionalOptions, self).show()
                        self.playout.addWidget(self)

                    def hide(self):
                        super(MyWindow.MainWidget.RatingsWidget.SingularRating.OptionalOptions, self).hide()
                        self.playout.removeWidget(self)


            def show(self):
                super(MyWindow.MainWidget.RatingsWidget, self).show()
        ...
        class TrialsWidget(Py.QtGui.QWidget):
            def __init__(self, parent=None):
                super(MyWindow.MainWidget.TrialsWidget, self).__init__(parent)
                self.parent = parent
            ...
            def show(self):
                super(MyWindow.MainWidget.TrialsWidget, self).show()
                self.parent.layout.addWidget(self)
